package com.example.pholatpibot;
...
public class GameView extends View
{
    ...
    private void initPipe() {
        sumpipe = 6;
        distance = 400*Constants.SCREEN_HEIGHT/2220;
        ...
        for (int i = 0; i < sumpipe; i++)
        {
            if (i<sumpipe/2)
            {
                ...
                this.arrPipes.get(this.arrPipes.size()-1).setBm(BitmapFactory.decodeResource(this.getResources(), R.drawable.tube));
            ...
            else
            {
                ...
                this.arrPipes.get(this.arrPipes.size()-1).setBm(BitmapFactory.decodeResource(this.getResources(), R.drawable.tube_op));
            }
        }
    }
    ...
    private void initBird() {
        ...
        bird.setHeight(100*Constants.SCREEN_HEIGHT/2220);
    ...
    public void draw(Canvas canvas)
    {
        ...
        else
        {
            ...
            {
                bird.setDrop(-15*Constants.SCREEN_HEIGHT/2220);
            }
            bird.draw(canvas);
        }
